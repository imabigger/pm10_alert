...
class DataUtils {
  static getTimeFromDateTime({required DateTime dataTime}) {
    return '${dataTime.year}-${dataTime.month}-${dataTime.day} ${dataTime.hour.toString().padLeft(2, '0')}:${dataTime.minute.toString().padLeft(2, '0')}';
  }
